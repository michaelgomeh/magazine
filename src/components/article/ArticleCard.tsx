...
const ArticleCard = ({article, view}: IArticleCardProps) => {
    ...
    return (
        <div className={classNames(styles.articleCard,{
            ...
            <div className={classNames(styles.footer, {[styles.show]: view === 'full'})}>
                <div className={styles.footerSection}>
                    <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 511.999 511.999" ><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
